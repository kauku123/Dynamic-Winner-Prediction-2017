...
def calculate_team_score(scores,team,matchState):
...
def output_relative_score(name,n,p,team_batting_second,matchState):
    ...
    if team_batting_second == data.keys()[0]:
        team_a_scores = calculate_team_score(data,data.keys()[0],matchState)
        team_b_scores = calculate_team_score(data,data.keys()[1],matchState)
    else:
        team_a_scores = calculate_team_score(data,data.keys()[1],matchState)
        team_b_scores = calculate_team_score(data,data.keys()[0],matchState)
