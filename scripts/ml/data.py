...
def get_data_for_ml(train_or_test,overs):
    if train_or_test == 0:
        path = '/home/kaustubh/intern_17/data/data_for_ml/train_data.yaml'
    elif train_or_test == 1:
        path = '/home/kaustubh/intern_17/data/data_for_ml/test_data.yaml'
    elif train_or_test == 2:
        path = '/home/kaustubh/intern_17/data/data_for_ml/validation_data.yaml'
